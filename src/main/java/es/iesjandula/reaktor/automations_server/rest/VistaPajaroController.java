...
//			}
//
//			List<ActuadorResponseDto> actuadores = this.actuadorRepository.buscarActuadoresPorUbicacion(nombreUbicacion);
//
//			List<SensorNumericoResponseDto> sensoresNumericos = this.sensorNumericoRepo.buscarSensoresNumericosPorUbicacion(nombreUbicacion);
//
//			List<SensorBooleanoResponseDto> sensoresBooleanos = this.sensorBooleanoRepo.buscarSensoresBooleanosPorUbicacion(nombreUbicacion);
//
//			DispositivosUbicacionResponseDto dispositivosUbicacionResponseDto = new DispositivosUbicacionResponseDto(nombreUbicacion, actuadores, sensoresNumericos, sensoresBooleanos);
//
